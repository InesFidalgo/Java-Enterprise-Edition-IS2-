...
public class NewStudent extends HttpServlet {
    ...
    private void printOG(PrintWriter out){
    	out.println("<h1>NEW STUDENT</h1>"
				+ "<form method=\"post\" action=\"NewStudent\">Name<p>"
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (name==null || password==null || number==null || firstYear==null || birth==null || email==null || alternateEmail==null || address==null || phone==null ){
			printOG(out);
				...
				ejbremote.WriteDataStudent(name, password, numberi, fyi, b, email,alternateEmail, address, phonei);
				out.println(name+" adicionado!!"+"<form method=\"post\" action=\"NewStudent\"><p class=\"submit\"><input type=\"submit\" name=\"commit\" value=\"ADD MORE\"></p></form>");
		}
	}
